...
class IconBundlePluginManager extends DefaultPluginManager {
	...
	public function __construct(
		...
		parent::__construct(
			// This tells the plugin manager to look for Icon Bundle plugins in
			// the 'src/Plugin/AmbientImpact/Icon/Bundle' subdirectory of any
			// enabled modules. This also serves to define the PSR-4
			// subnamespace in which Icon Bundle plugins will live.
			...
			// The name of the interface that plugins should adhere to. Drupal
			// will enforce this as a requirement. If a plugin does not
			// implement this interface, Drupal will throw an error.
		...
		// for any classes with an IconBundleAnnotation. The annotations are
	...
	public function getIconBundleInstances(array $iconBundleIDs = []) {
		...
		// If no IDs were specified, attempt to get an instance of all
		// discovered plugins.
