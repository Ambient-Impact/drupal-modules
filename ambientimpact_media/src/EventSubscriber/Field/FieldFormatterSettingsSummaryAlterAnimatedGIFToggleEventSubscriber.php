 ...
 */
class FieldFormatterSettingsSummaryAlterAnimatedGIFToggleEventSubscriber implements
EventSubscriberInterface {
  ...
  /**
   * Add animated GIF toggle image field formatter summary.
   *
   * This displays a message on image formatters linked an image file if the
   * animated GIF toggle is set to be used.
   *
  ...
  public function fieldFormatterSettingsSummaryAlter(
    ...
    if (
      ...
      $event->getSummary()[] = $this->t('Uses animated GIF toggle');
    }
  }
}
